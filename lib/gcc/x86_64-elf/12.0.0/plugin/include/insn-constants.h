...
enum unspec {
  ...
  UNSPEC_COMPLEX_FMUL = 214,
  UNSPEC_COMPLEX_FCMUL = 215,
  UNSPEC_COMPLEX_MASK = 216,
  UNSPEC_LFENCE = 217,
  UNSPEC_SFENCE = 218,
  UNSPEC_MFENCE = 219,
  UNSPEC_FILD_ATOMIC = 220,
  UNSPEC_FIST_ATOMIC = 221,
  UNSPEC_LDX_ATOMIC = 222,
  UNSPEC_STX_ATOMIC = 223,
  UNSPEC_LDA = 224,
  UNSPEC_STA = 225
};
#define NUM_UNSPEC_VALUES 226
