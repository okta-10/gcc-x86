...
enum opt_code
{
  ...
  OPT_Wtsan = 791,                           /* -Wtsan */
  OPT_Wtype_limits = 792,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 793,            /* -Wundeclared-selector */
  OPT_Wundef = 794,                          /* -Wundef */
  OPT_Wundefined_do_loop = 795,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 796,                      /* -Wunderflow */
  OPT_Wuninitialized = 797,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 798,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 799, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 800, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 801,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 802,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 803,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 804,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 805, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 806,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 807,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 808,                /* -Wunused-function */
  OPT_Wunused_label = 809,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 810,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 811,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 812,               /* -Wunused-parameter */
  OPT_Wunused_result = 813,                  /* -Wunused-result */
  OPT_Wunused_value = 814,                   /* -Wunused-value */
  OPT_Wunused_variable = 815,                /* -Wunused-variable */
  OPT_Wuse_after_free = 816,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 817,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 818,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 819,                   /* -Wuseless-cast */
  OPT_Wvarargs = 820,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 821,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 822,   /* -Wvector-operation-performance */
  OPT_Wvexing_parse = 823,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 824,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 825,            /* -Wvirtual-move-assign */
  OPT_Wvla = 826,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 827,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 828,                  /* -Wvla-parameter */
  OPT_Wvolatile = 829,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 830,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 831,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 832,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 833,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 834,                       /* -Wzerotrip */
  OPT_X = 835,                               /* -X */
  OPT_Xassembler = 836,                      /* -Xassembler */
  OPT_Xf = 837,                              /* -Xf */
  OPT_Xlinker = 838,                         /* -Xlinker */
  OPT_Xpreprocessor = 839,                   /* -Xpreprocessor */
  OPT_Z = 840,                               /* -Z */
  OPT_ansi = 841,                            /* -ansi */
  OPT_aux_info = 842,                        /* -aux-info */
  /* OPT_aux_info_ = 843, */                 /* -aux-info= */
  OPT_c = 844,                               /* -c */
  OPT_callgraph = 845,                       /* -callgraph */
  OPT_coverage = 846,                        /* -coverage */
  OPT_cpp = 847,                             /* -cpp */
  OPT_cpp_ = 848,                            /* -cpp= */
  OPT_d = 849,                               /* -d */
  OPT_debuglib_ = 850,                       /* -debuglib= */
  OPT_defaultlib_ = 851,                     /* -defaultlib= */
  OPT_defined_only = 852,                    /* -defined-only */
  OPT_demangle = 853,                        /* -demangle */
  OPT_dstartfiles = 854,                     /* -dstartfiles */
  OPT_dump_body_ = 855,                      /* -dump-body= */
  OPT_dump_level_ = 856,                     /* -dump-level= */
  OPT_dumpbase = 857,                        /* -dumpbase */
  OPT_dumpbase_ext = 858,                    /* -dumpbase-ext */
  OPT_dumpdir = 859,                         /* -dumpdir */
  OPT_dumpfullversion = 860,                 /* -dumpfullversion */
  OPT_dumpmachine = 861,                     /* -dumpmachine */
  OPT_dumpspecs = 862,                       /* -dumpspecs */
  OPT_dumpversion = 863,                     /* -dumpversion */
  OPT_e = 864,                               /* -e */
  OPT_export_dynamic = 865,                  /* -export-dynamic */
  OPT_fPIC = 866,                            /* -fPIC */
  OPT_fPIE = 867,                            /* -fPIE */
  OPT_fRTS_ = 868,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 869,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 870,                   /* -fabi-version= */
  OPT_faccess_control = 871,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 872,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 873,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 874,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 875,                  /* -falign-commons */
  OPT_falign_functions = 876,                /* -falign-functions */
  OPT_falign_functions_ = 877,               /* -falign-functions= */
  OPT_falign_jumps = 878,                    /* -falign-jumps */
  OPT_falign_jumps_ = 879,                   /* -falign-jumps= */
  OPT_falign_labels = 880,                   /* -falign-labels */
  OPT_falign_labels_ = 881,                  /* -falign-labels= */
  OPT_falign_loops = 882,                    /* -falign-loops */
  OPT_falign_loops_ = 883,                   /* -falign-loops= */
  /* OPT_faligned_new = 884, */              /* -faligned-new */
  OPT_faligned_new_ = 885,                   /* -faligned-new= */
  OPT_fall_instantiations = 886,             /* -fall-instantiations */
  OPT_fall_intrinsics = 887,                 /* -fall-intrinsics */
  OPT_fall_virtual = 888,                    /* -fall-virtual */
  OPT_fallocation_dce = 889,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 890,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 891,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 892,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 893,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 894,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 895,         /* -falt-external-templates */
  OPT_fanalyzer = 896,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 897,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 898,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 899,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 900,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 901,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 902,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 903,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 904,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 905,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 906, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 907,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 908, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 909, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 910, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 911, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 912,            /* -fasan-shadow-offset= */
  OPT_fasm = 913,                            /* -fasm */
  OPT_fassert = 914,                         /* -fassert */
  OPT_fassociative_math = 915,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 916,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 917,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 918,                   /* -fauto-profile */
  OPT_fauto_profile_ = 919,                  /* -fauto-profile= */
  OPT_fautomatic = 920,                      /* -fautomatic */
  OPT_fbackslash = 921,                      /* -fbackslash */
  OPT_fbacktrace = 922,                      /* -fbacktrace */
  OPT_fbit_tests = 923,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 924,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 925,                   /* -fbounds-check */
  OPT_fbounds_check_ = 926,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 927,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 928,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 929, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 930, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 931, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 932,                /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 933,           /* -fbuilding-libgfortran */
  ...
  OPT_list = 1758,                           /* -list */
  OPT_m128bit_long_double = 1759,            /* -m128bit-long-double */
  OPT_m16 = 1760,                            /* -m16 */
  OPT_m32 = 1761,                            /* -m32 */
  OPT_m3dnow = 1762,                         /* -m3dnow */
  OPT_m3dnowa = 1763,                        /* -m3dnowa */
  OPT_m64 = 1764,                            /* -m64 */
  OPT_m80387 = 1765,                         /* -m80387 */
  OPT_m8bit_idiv = 1766,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1767,             /* -m96bit-long-double */
  OPT_mabi_ = 1768,                          /* -mabi= */
  OPT_mabm = 1769,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1770,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1771,                 /* -maddress-mode= */
  OPT_madx = 1772,                           /* -madx */
  OPT_maes = 1773,                           /* -maes */
  OPT_malign_data_ = 1774,                   /* -malign-data= */
  OPT_malign_double = 1775,                  /* -malign-double */
  OPT_malign_functions_ = 1776,              /* -malign-functions= */
  OPT_malign_jumps_ = 1777,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1778,                  /* -malign-loops= */
  OPT_malign_stringops = 1779,               /* -malign-stringops */
  OPT_mamx_bf16 = 1780,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1781,                      /* -mamx-int8 */
  OPT_mamx_tile = 1782,                      /* -mamx-tile */
  OPT_march_ = 1783,                         /* -march= */
  OPT_masm_ = 1784,                          /* -masm= */
  OPT_mavx = 1785,                           /* -mavx */
  OPT_mavx2 = 1786,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1787,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1788,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1789,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1790,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1791,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1792,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1793,                      /* -mavx512bw */
  OPT_mavx512cd = 1794,                      /* -mavx512cd */
  OPT_mavx512dq = 1795,                      /* -mavx512dq */
  OPT_mavx512er = 1796,                      /* -mavx512er */
  OPT_mavx512f = 1797,                       /* -mavx512f */
  OPT_mavx512fp16 = 1798,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1799,                    /* -mavx512ifma */
  OPT_mavx512pf = 1800,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1801,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1802,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1803,                      /* -mavx512vl */
  OPT_mavx512vnni = 1804,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1805,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1806,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1807,                       /* -mavxvnni */
  OPT_mbmi = 1808,                           /* -mbmi */
  OPT_mbmi2 = 1809,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1810,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1811,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1812,                    /* -mcet-switch */
  OPT_mcld = 1813,                           /* -mcld */
  OPT_mcldemote = 1814,                      /* -mcldemote */
  OPT_mclflushopt = 1815,                    /* -mclflushopt */
  OPT_mclwb = 1816,                          /* -mclwb */
  OPT_mclzero = 1817,                        /* -mclzero */
  OPT_mcmodel_ = 1818,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1819, */                    /* -mcpu= */
  OPT_mcrc32 = 1820,                         /* -mcrc32 */
  OPT_mcx16 = 1821,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1822,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1823,            /* -mdump-tune-features */
  OPT_menqcmd = 1824,                        /* -menqcmd */
  OPT_mf16c = 1825,                          /* -mf16c */
  OPT_mfancy_math_387 = 1826,                /* -mfancy-math-387 */
  OPT_mfentry = 1827,                        /* -mfentry */
  OPT_mfentry_name_ = 1828,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1829,               /* -mfentry-section= */
  OPT_mfma = 1830,                           /* -mfma */
  OPT_mfma4 = 1831,                          /* -mfma4 */
  OPT_mforce_drap = 1832,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1833,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1834,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1835,                       /* -mfpmath= */
  OPT_mfsgsbase = 1836,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1837,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1838, */              /* -mfused-madd */
  OPT_mfxsr = 1839,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1840,             /* -mgeneral-regs-only */
  OPT_mgfni = 1841,                          /* -mgfni */
  OPT_mhard_float = 1842,                    /* -mhard-float */
  OPT_mharden_sls_ = 1843,                   /* -mharden-sls= */
  OPT_mhle = 1844,                           /* -mhle */
  OPT_mhreset = 1845,                        /* -mhreset */
  OPT_miamcu = 1846,                         /* -miamcu */
  OPT_mieee_fp = 1847,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1848,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1849,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1850,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1851,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1852,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1853,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1854,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1855, */            /* -mintel-syntax */
  OPT_mkl = 1856,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1857,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1858,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1859,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1860,                /* -mlong-double-80 */
  OPT_mlwp = 1861,                           /* -mlwp */
  OPT_mlzcnt = 1862,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1863,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1864,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1865,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1866,                  /* -mmitigate-rop */
  OPT_mmmx = 1867,                           /* -mmmx */
  OPT_mmovbe = 1868,                         /* -mmovbe */
  OPT_mmovdir64b = 1869,                     /* -mmovdir64b */
  OPT_mmovdiri = 1870,                       /* -mmovdiri */
  OPT_mmove_max_ = 1871,                     /* -mmove-max= */
  OPT_mmpx = 1872,                           /* -mmpx */
  OPT_mms_bitfields = 1873,                  /* -mms-bitfields */
  OPT_mmwait = 1874,                         /* -mmwait */
  OPT_mmwaitx = 1875,                        /* -mmwaitx */
  OPT_mneeded = 1876,                        /* -mneeded */
  OPT_mno_align_stringops = 1877,            /* -mno-align-stringops */
  OPT_mno_default = 1878,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1879,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1880,                  /* -mno-push-args */
  OPT_mno_red_zone = 1881,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1882,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1883,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1884,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1885,                          /* -mpc32 */
  OPT_mpc64 = 1886,                          /* -mpc64 */
  OPT_mpc80 = 1887,                          /* -mpc80 */
  OPT_mpclmul = 1888,                        /* -mpclmul */
  OPT_mpcommit = 1889,                       /* -mpcommit */
  OPT_mpconfig = 1890,                       /* -mpconfig */
  OPT_mpku = 1891,                           /* -mpku */
  OPT_mpopcnt = 1892,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1893, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1894,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1895,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1896,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1897,                        /* -mprfchw */
  OPT_mptwrite = 1898,                       /* -mptwrite */
  OPT_mpush_args = 1899,                     /* -mpush-args */
  OPT_mrdpid = 1900,                         /* -mrdpid */
  OPT_mrdrnd = 1901,                         /* -mrdrnd */
  OPT_mrdseed = 1902,                        /* -mrdseed */
  OPT_mrecip = 1903,                         /* -mrecip */
  OPT_mrecip_ = 1904,                        /* -mrecip= */
  OPT_mrecord_mcount = 1905,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1906,                 /* -mrecord-return */
  OPT_mred_zone = 1907,                      /* -mred-zone */
  OPT_mregparm_ = 1908,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1909,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1910,                           /* -mrtd */
  OPT_mrtm = 1911,                           /* -mrtm */
  OPT_msahf = 1912,                          /* -msahf */
  OPT_mserialize = 1913,                     /* -mserialize */
  OPT_msgx = 1914,                           /* -msgx */
  OPT_msha = 1915,                           /* -msha */
  OPT_mshstk = 1916,                         /* -mshstk */
  OPT_mskip_rax_setup = 1917,                /* -mskip-rax-setup */
  OPT_msoft_float = 1918,                    /* -msoft-float */
  OPT_msse = 1919,                           /* -msse */
  OPT_msse2 = 1920,                          /* -msse2 */
  OPT_msse2avx = 1921,                       /* -msse2avx */
  OPT_msse3 = 1922,                          /* -msse3 */
  OPT_msse4 = 1923,                          /* -msse4 */
  OPT_msse4_1 = 1924,                        /* -msse4.1 */
  OPT_msse4_2 = 1925,                        /* -msse4.2 */
  OPT_msse4a = 1926,                         /* -msse4a */
  /* OPT_msse5 = 1927, */                    /* -msse5 */
  OPT_msseregparm = 1928,                    /* -msseregparm */
  OPT_mssse3 = 1929,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1930,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1931, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1932,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1933, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1934,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1935,                  /* -mstackrealign */
  OPT_mstore_max_ = 1936,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 1937,            /* -mstringop-strategy= */
  OPT_mstv = 1938,                           /* -mstv */
  OPT_mtbm = 1939,                           /* -mtbm */
  OPT_mtls_dialect_ = 1940,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1941,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1942,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1943,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1944,                         /* -mtune= */
  OPT_muintr = 1945,                         /* -muintr */
  OPT_mvaes = 1946,                          /* -mvaes */
  OPT_mveclibabi_ = 1947,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1948,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1949,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1950,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1951,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1952,                      /* -mwbnoinvd */
  OPT_mwidekl = 1953,                        /* -mwidekl */
  OPT_mx32 = 1954,                           /* -mx32 */
  OPT_mxop = 1955,                           /* -mxop */
  OPT_mxsave = 1956,                         /* -mxsave */
  OPT_mxsavec = 1957,                        /* -mxsavec */
  OPT_mxsaveopt = 1958,                      /* -mxsaveopt */
  OPT_mxsaves = 1959,                        /* -mxsaves */
  OPT_n = 1960,                              /* -n */
  OPT_name_sort = 1961,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1962,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1963,              /* -no-integrated-cpp */
  OPT_no_pie = 1964,                         /* -no-pie */
  OPT_nocpp = 1965,                          /* -nocpp */
  OPT_nodefaultlibs = 1966,                  /* -nodefaultlibs */
  OPT_nolibc = 1967,                         /* -nolibc */
  OPT_nophoboslib = 1968,                    /* -nophoboslib */
  OPT_nostartfiles = 1969,                   /* -nostartfiles */
  OPT_nostdinc = 1970,                       /* -nostdinc */
  OPT_nostdinc__ = 1971,                     /* -nostdinc++ */
  OPT_nostdlib = 1972,                       /* -nostdlib */
  OPT_o = 1973,                              /* -o */
  OPT_objects = 1974,                        /* -objects */
  OPT_p = 1975,                              /* -p */
  OPT_pass_exit_codes = 1976,                /* -pass-exit-codes */
  /* OPT_pedantic = 1977, */                 /* -pedantic */
  OPT_pedantic_errors = 1978,                /* -pedantic-errors */
  OPT_pg = 1979,                             /* -pg */
  OPT_pie = 1980,                            /* -pie */
  OPT_pipe = 1981,                           /* -pipe */
  OPT_print_file_name_ = 1982,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1983,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1984,          /* -print-multi-directory */
  OPT_print_multi_lib = 1985,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1986,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1987,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1988,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1989,               /* -print-prog-name= */
  OPT_print_search_dirs = 1990,              /* -print-search-dirs */
  OPT_print_sysroot = 1991,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1992,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1993,                    /* -print-value */
  OPT_quiet = 1994,                          /* -quiet */
  OPT_r = 1995,                              /* -r */
  OPT_remap = 1996,                          /* -remap */
  OPT_reverse_sort = 1997,                   /* -reverse-sort */
  OPT_s = 1998,                              /* -s */
  OPT_save_temps = 1999,                     /* -save-temps */
  OPT_save_temps_ = 2000,                    /* -save-temps= */
  OPT_shared = 2001,                         /* -shared */
  OPT_shared_libgcc = 2002,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2003,               /* -shared-libphobos */
  OPT_size_sort = 2004,                      /* -size-sort */
  /* OPT_specs = 2005, */                    /* -specs */
  OPT_specs_ = 2006,                         /* -specs= */
  OPT_static = 2007,                         /* -static */
  OPT_static_libasan = 2008,                 /* -static-libasan */
  OPT_static_libgcc = 2009,                  /* -static-libgcc */
  OPT_static_libgfortran = 2010,             /* -static-libgfortran */
  OPT_static_libgo = 2011,                   /* -static-libgo */
  OPT_static_libhwasan = 2012,               /* -static-libhwasan */
  OPT_static_liblsan = 2013,                 /* -static-liblsan */
  OPT_static_libmpx = 2014,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2015,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2016,               /* -static-libphobos */
  OPT_static_libstdc__ = 2017,               /* -static-libstdc++ */
  OPT_static_libtsan = 2018,                 /* -static-libtsan */
  OPT_static_libubsan = 2019,                /* -static-libubsan */
  OPT_static_pie = 2020,                     /* -static-pie */
  /* OPT_std_c__03 = 2021, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2022, */                /* -std=c++0x */
  OPT_std_c__11 = 2023,                      /* -std=c++11 */
  OPT_std_c__14 = 2024,                      /* -std=c++14 */
  OPT_std_c__17 = 2025,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2026, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2027, */                /* -std=c++1z */
  OPT_std_c__20 = 2028,                      /* -std=c++20 */
  OPT_std_c__23 = 2029,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2030, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2031, */                /* -std=c++2b */
  OPT_std_c__98 = 2032,                      /* -std=c++98 */
  OPT_std_c11 = 2033,                        /* -std=c11 */
  OPT_std_c17 = 2034,                        /* -std=c17 */
  /* OPT_std_c18 = 2035, */                  /* -std=c18 */
  /* OPT_std_c1x = 2036, */                  /* -std=c1x */
  OPT_std_c2x = 2037,                        /* -std=c2x */
  /* OPT_std_c89 = 2038, */                  /* -std=c89 */
  OPT_std_c90 = 2039,                        /* -std=c90 */
  OPT_std_c99 = 2040,                        /* -std=c99 */
  /* OPT_std_c9x = 2041, */                  /* -std=c9x */
  OPT_std_f2003 = 2042,                      /* -std=f2003 */
  OPT_std_f2008 = 2043,                      /* -std=f2008 */
  OPT_std_f2008ts = 2044,                    /* -std=f2008ts */
  OPT_std_f2018 = 2045,                      /* -std=f2018 */
  OPT_std_f95 = 2046,                        /* -std=f95 */
  OPT_std_gnu = 2047,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2048, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2049, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2050,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2051,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2052,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2053, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2054, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2055,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2056,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2057, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2058, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2059,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2060,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2061,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2062, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2063, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2064,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2065, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2066,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2067,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2068, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2069, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2070,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2071, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2072, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2073, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2074, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2075, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2076,                     /* -std=legacy */
  OPT_stdlib_ = 2077,                        /* -stdlib= */
  OPT_symbol_ = 2078,                        /* -symbol= */
  OPT_symbolic = 2079,                       /* -symbolic */
  OPT_t = 2080,                              /* -t */
  OPT_time = 2081,                           /* -time */
  OPT_time_ = 2082,                          /* -time= */
  OPT_traditional = 2083,                    /* -traditional */
  OPT_traditional_cpp = 2084,                /* -traditional-cpp */
  OPT_tree_stats = 2085,                     /* -tree-stats */
  OPT_trigraphs = 2086,                      /* -trigraphs */
  OPT_type_stats = 2087,                     /* -type-stats */
  OPT_u = 2088,                              /* -u */
  OPT_undef = 2089,                          /* -undef */
  OPT_v = 2090,                              /* -v */
  OPT_version = 2091,                        /* -version */
  OPT_w = 2092,                              /* -w */
  OPT_wrapper = 2093,                        /* -wrapper */
  OPT_x = 2094,                              /* -x */
  OPT_z = 2095,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
